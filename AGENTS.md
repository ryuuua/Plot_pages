...
- Sandbox automation: `bash /Users/ryua/code/mcp_sandbox/scripts/factory_auto.sh --token <TOKEN> --repo-id plotpages --repo-name plotpages --branch "$(git rev-parse --abbrev-ref HEAD)"`
